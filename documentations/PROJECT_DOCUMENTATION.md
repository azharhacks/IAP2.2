...
## 🎯 TEAM PRESENTATION RESPONSIBILITIES

### **1. Devyan Jethwa** - Products, Login, Signup & 2FA
**Components to Present:**
- **Product Management System** (`ProductManager.php`, `products.php`, `product.php`)
  - Product catalog with 40+ sample products
  - Category and brand filtering system
  - Featured products display
  - Product search functionality
  - Related products algorithm
  
- **Authentication System** (`Signin.php`, `Signup.php`, `2fa_verify.php`)
...
**Key Demo Points:**
- Show product browsing and filtering
- Demonstrate user registration flow
- Show 2FA setup with QR code
- Test login with 2FA verification

### **2. Azhar** - Orders and Layout System
**Components to Present:**
- **Order Management System** (`OrderManager.php`, `orders.php`, `order_confirmation.php`)
...
- **Layout System** (`Abstract/Layout.php`)
  - Centralized layout management
  - Responsive Bootstrap 5 design
  - Navigation system with dropdowns
  - Page header, footer, and breadcrumb components
  - Glassmorphism UI effects

**Key Demo Points:**
- Show order placement process
- Demonstrate order status updates
- Show admin order management panel
- Highlight responsive design features

### **3. Ian** - Cart, Addresses and Profile
**Components to Present:**
- **Shopping Cart System** (`CartManager.php`, `cart.php`, `cart_ajax.php`)
  - Real-time cart updates via AJAX
  - Session and database cart management
...
- **Address Management** (`addresses.php`)
  ...
  - Kenyan location fields (county, postal code)
...
**Key Demo Points:**
- Show adding/removing items from cart
- Demonstrate AJAX cart updates
- Show address management features
- Display profile editing functionality

### **4. Sanaet** - Backend & Database (phpMyAdmin)
**Components to Present:**
- **Database Architecture** (Complete schema with 12+ tables)
  - Users and authentication tables
  - Product catalog structure
  - Order management tables
  - Cart and address relationships
  
- **Backend Configuration** (`config.php`, database connections)
  - Database connection management
  - Environment configuration
  - Error handling and logging
  
- **phpMyAdmin Demonstration**
  - Show all database tables and relationships
  - Display sample data (40 products, categories, users)
  - Demonstrate foreign key constraints
  - Show data integrity features

**Key Demo Points:**
- Walk through database schema in phpMyAdmin
- Show table relationships and constraints
- Display sample data and structure
- Explain data flow between tables

### **5. Alvin** - ClassAutoLoad, Users (User, Admin, Super Admin)
**Components to Present:**
- **Class Autoloading System** (`ClassAutoload.php`)
  - PSR-4 compatible autoloading
  - Automatic class discovery
  - Namespace management
  - Clean code organization
  
- **User Role Management System** (`admin/users.php`, `admin/user_details.php`)
  - Three-tier user system: User, Admin, Super Admin
  - Role-based access control
  - User management interface with CRUD operations
  - Safety measures (preventing deletion of last admin)
  
- **Admin Panel Features**
  - User role changes and status management
  - Comprehensive user details view
  - User statistics and order history
  - Security restrictions and permissions

**Key Demo Points:**
- Explain autoloading system benefits
- Show different user role capabilities
...
├── addresses     Each person will have to prep on:
1. Devyan- Products and Login x Signup x 2FA
2. Azhar - Orders and Layout
3. Ian - Cart, Addresses and Profile
4. Sanaet - Backend x Database on phpmyadmin part
5. Alvin - ClassAutoLoad, Users-(User, Admin and SuperAdmin)       (User Shipping Addresses)
...
1. **Database Ready**: Import `complete_ecommerce_schema.sql` with sample data
2. **Server Running**: Start PHP development server (`php -S localhost:8000`)
3. **Test Accounts**: Create demo users with different roles
4. **Sample Data**: Ensure 40+ products and categories are populated

### Team Member Quick Reference

| Team Member | Primary Components | Key Files | Demo Focus |
|-------------|-------------------|-----------|------------|
| **Devyan** | Products + Auth | `ProductManager.php`, `Signin.php`, `2fa_verify.php` | Product browsing, Login flow, 2FA setup |
| **Azhar** | Orders + Layout | `OrderManager.php`, `Layout.php`, `admin/orders.php` | Order process, Admin panel, UI design |
| **Ian** | Cart + Profile | `CartManager.php`, `cart.php`, `profile.php` | Cart operations, Address mgmt, Profile |
| **Sanaet** | Database + Backend | `config.php`, phpMyAdmin, Database schema | Database structure, Tables, Relationships |
| **Alvin** | Classes + Users | `ClassAutoload.php`, `admin/users.php` | Autoloading, User roles, Admin features |

### Live Demo Flow Suggestion
1. **Start**: Homepage with featured products (Devyan)
2. **Register**: New user signup with 2FA (Devyan)
3. **Browse**: Product catalog and filtering (Devyan)
4. **Shop**: Add items to cart (Ian)
5. **Profile**: Add address and profile info (Ian)
6. **Checkout**: Place order (Azhar)
7. **Admin**: Show user and order management (Alvin + Azhar)
8. **Database**: Walk through phpMyAdmin structure (Sanaet)
